...
const Review = ({
  ...
  return (
    <div class="card mb-20 rounded-lg bg-base-200 p-5">
      <p class="text-base-content">{review}</p>
      <div class="grid grid-cols-12 bg-base-100 text-base-content">
...
const Reviews = () => {
  return (
    <section class="columns-2 gap-32 bg-base-300 p-5 md:p-20">
      <Review
        name="Jiyoung K."
      ...
      >
        <StaticImage src="../../images/jiyoung.jpg" alt="Jiyoung" />
      </Review>
